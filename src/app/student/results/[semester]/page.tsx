...
const allResultsData: Record<string, { sgpa: string, results: any[] }> = {
  "1-1": {
    sgpa: "8.5",
    results: [
  ...
  "2-1": {
    ...
    results: [
        ...
        { subjectCode: "MA211", subjectName: "Linear Algebra", grade: "A", credits: 4 },
      ...
      <Card>
        <CardHeader className="flex flex-row justify-between items-center">
          <div>
            ...
            <CardDescription>SGPA: <span className="font-bold text-primary text-xl">{semesterData.sgpa}</span></CardDescription>
          </div>
                  ...
                  {semesterData.results.map((result) => (
                    <TableRow key={result.subjectCode}>
                      ...
                      <TableCell className="text-right">
                        <Badge variant="default" className="w-10 h-8 flex items-center justify-center text-base">{result.grade}</Badge>
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
